...
A.JulianDay.jdFromGregorian = function (y, m, d) {
	new A.JulianDay(A.JulianDay.jdFromGregorian(y, m, d));
};
...
A.JulianDay.jdFromJulian = function (y, m, d) {
	new A.JulianDay(A.JulianDay.calendarJulianToJD(y, m, d));
};
...
A.JulianDay.jdToDate = function (jd) {
	...
	return new Date(Date.UTC(cal.y, cal.m-1, cal.d, hours, minutes, seconds));
};
