...
1941>b?(b-=1920,21.2+.84493*b-.0761*a(b,2)+.0020936*a(b,3)):1961>b?(b-=1950,29.07+.407*b-a(b,2)/233+a(b,3)/2547):1986>b?(b-=1975,45.45+1.067*b-a(b,2)/260-a(b,3)/718):2005>b?(b-=2E3,63.86+.3345*b-.060374*a(b,2)+.0017275*a(b,3)+6.51814E-4*a(b,4)+2.373599E-5*a(b,5)):2050>b?(b-=2E3,62.92+.32217*b+.005589*a(b,2)):2150>b?-20+32*a((b-1820)/100,2)-.5628*(2150-b):-20+32*a((b-1820)/100,2)}};A.Globe={Er:6378.14,Fl:1/298.257,parallaxConstants:function(a,b){b||(b=0);var c=1-A.Globe.Fl,d=.001*b/A.Globe.Er;return{rhoslat:Math.sin(Math.atan(c*Math.tan(a)))*c+d*Math.sin(a),rhoclat:Math.cos(Math.atan(c*Math.tan(a)))+d*Math.cos(a)}}};A.Interp={newLen3:function(a,b,c){if(3!=c.length)throw"Error not 3";if(b==a)throw"Error no x range";var d=c[1]-c[0],e=c[2]-c[1];return{x1:a,x3:b,y:c,a:d,b:e,c:e-d,abSum:d+e,xSum:b+a,xDiff:b-a}},interpolateX:function(a,b){return A.Interp.interpolateN(a,(2*b-a.xSum)/a.xDiff)},interpolateN:function(a,b){return a.y[1]+.5*b*(a.abSum+b*a.c)}};A.JulianDay=function(a,b){a instanceof Date&&(a=A.JulianDay.dateToJD(a));this.jd=a;this.deltaT=b?b:A.DeltaT.estimate(this.jd);this.jde=A.DeltaT.jdToJde(this.jd,this.deltaT)};A.JulianDay.prototype={toCalendar:function(){return A.JulianDay.jdToCalendar(this.jd)},jdJ2000Century:function(){return(this.jd-A.J2000)/A.JulianCentury},jdeJ2000Century:function(){return(this.jde-A.J2000)/A.JulianCentury},startOfDay:function(){return new A.JulianDay(Math.floor(this.jde-.5)+.5,this.deltaT)}};
A.JulianDay.gregorianTimeStart=Date.UTC(1582,9,4);A.JulianDay.jdFromGregorian=function(a,b,c){new A.JulianDay(A.JulianDay.jdFromGregorian(a,b,c))};A.JulianDay.jdFromJulian=function(a,b,c){new A.JulianDay(A.JulianDay.calendarJulianToJD(a,b,c))};
...
e.rhoclat,b.lng,c),delta:d.delta}},topocentricPosition:function(a,b,c){var d=A.Sidereal.apparentInRa(a);a=A.Moon.apparentTopocentric(a,b,d);var e=A.Coord.eqToHz(a.eq,b,d);!0===c&&(e.alt+=A.Refraction.bennett2(e.alt));b=A.Moon.parallacticAngle(b.lat,d-(b.lng+a.eq.ra),a.eq.dec);return{hz:e,eq:a.eq,delta:a.delta,q:b}},approxTimes:function(a,b){a=a.startOfDay();var c=A.Moon.apparentTopocentric(a,b),d=A.Moon.parallax(c.delta),d=A.Rise.stdh0Lunar(d),e=A.Sidereal.apparent0UT(a);return A.Rise.approxTimes(b,
d,e,c.eq)},times:function(a,b){a=a.startOfDay();var c=A.Moon.apparentTopocentric(new A.JulianDay(a.jd-1,a.deltaT),b),d=A.Moon.apparentTopocentric(a,b),e=A.Moon.apparentTopocentric(new A.JulianDay(a.jd+1,a.deltaT),b),f=A.Moon.parallax(d.delta),f=A.Rise.stdh0Lunar(f),g=A.Sidereal.apparent0UT(a);return A.Rise.times(b,a.deltaT,f,g,[c.eq,d.eq,e.eq])},parallacticAngle:function(a,b,c){return Math.atan(Math.sin(b),Math.tan(a)*Math.cos(c)-Math.sin(c)*Math.cos(b))},geocentricPosition:function(a){var b=Math.PI/
180,c=a.jdeJ2000Century();a=A.Math.pMod(A.Math.horner(c,[218.3164477*b,481267.88123421*b,-.0015786*b,b/538841,-b/65194E3]),2*Math.PI);for(var d=A.Math.pMod(A.Math.horner(c,[297.8501921*b,445267.1114034*b,-.0018819*b,b/545868,-b/113065E3]),2*Math.PI),e=A.Math.pMod(A.Math.horner(c,[357.5291092*b,35999.0502909*b,-1.535E-4*b,b/2449E4]),2*Math.PI),f=A.Math.pMod(A.Math.horner(c,[134.9633964*b,477198.8675055*b,.0087414*b,b/69699,-b/14712E3]),2*Math.PI),g=A.Math.pMod(A.Math.horner(c,[93.272095*b,483202.0175233*
b,-.0036539*b,-b/3526E3,b/86331E4]),2*Math.PI),k=119.75*b+131.849*b*c,m=53.09*b+479264.29*b*c,h=313.45*b+481266.484*b*c,c=A.Math.horner(c,[1,-.002516,-7.4E-6]),p=c*c,m=3958*Math.sin(k)+1962*Math.sin(a-g)+318*Math.sin(m),n=0,k=-2235*Math.sin(a)+382*Math.sin(h)+175*Math.sin(k-g)+175*Math.sin(k+g)+127*Math.sin(a-f)-115*Math.sin(a+f),l,h=0;h<A.Moon.ta.length;h++){l=A.Moon.ta[h];var r=d*l[0]+e*l[1]+f*l[2]+g*l[3],q=Math.sin(r),r=Math.cos(r);switch(l[1]){case 0:m+=l[4]*q;n+=l[5]*r;break;case 1:case -1:m+=
l[4]*q*c;n+=l[5]*r*c;break;case 2:case -2:m+=l[4]*q*p;n+=l[5]*r*p;break;default:throw"error";}}for(h=0;h<A.Moon.tb.length;h++)switch(l=A.Moon.tb[h],q=Math.sin(d*l[0]+e*l[1]+f*l[2]+g*l[3]),l[1]){case 0:k+=l[4]*q;break;case 1:case -1:k+=l[4]*q*c;break;case 2:case -2:k+=l[4]*q*p;break;default:throw"error";}return{lng:A.Math.pMod(a,2*Math.PI)+1E-6*m*b,lat:1E-6*k*b,delta:385000.56+.001*n}},ta:[[0,0,1,0,6288774,-20905355],[2,0,-1,0,1274027,-3699111],[2,0,0,0,658314,-2955968],[0,0,2,0,213618,-569925],[0,
1,0,0,-185116,48888],[0,0,0,2,-114332,-3149],[2,0,-2,0,58793,246158],[2,-1,-1,0,57066,-152138],[2,0,1,0,53322,-170733],[2,-1,0,0,45758,-204586],[0,1,-1,0,-40923,-129620],[1,0,0,0,-34720,108743],[0,1,1,0,-30383,104755],[2,0,0,-2,15327,10321],[0,0,1,2,-12528,0],[0,0,1,-2,10980,79661],[4,0,-1,0,10675,-34782],[0,0,3,0,10034,-23210],[4,0,-2,0,8548,-21636],[2,1,-1,0,-7888,24208],[2,1,0,0,-6766,30824],[1,0,-1,0,-5163,-8379],[1,1,0,0,4987,-16675],[2,-1,1,0,4036,-12831],[2,0,2,0,3994,-10445],[4,0,0,0,3861,
-11650],[2,0,-3,0,3665,14403],[0,1,-2,0,-2689,-7003],[2,0,-1,2,-2602,0],[2,-1,-2,0,2390,10056],[1,0,1,0,-2348,6322],[2,-2,0,0,2236,-9884],[0,1,2,0,-2120,5751],[0,2,0,0,-2069,0],[2,-2,-1,0,2048,-4950],[2,0,1,-2,-1773,4130],[2,0,0,2,-1595,0],[4,-1,-1,0,1215,-3958],[0,0,2,2,-1110,0],[3,0,-1,0,-892,3258],[2,1,1,0,-810,2616],[4,-1,-2,0,759,-1897],[0,2,-1,0,-713,-2117],[2,2,-1,0,-700,2354],[2,1,-2,0,691,0],[2,-1,0,-2,596,0],[4,0,1,0,549,-1423],[0,0,4,0,537,-1117],[4,-1,0,0,520,-1571],[1,0,-2,0,-487,-1739],
[2,1,0,-2,-399,0],[0,0,2,-2,-381,-4421],[1,1,1,0,351,0],[3,0,-2,0,-340,0],[4,0,-3,0,330,0],[2,-1,2,0,327,0],[0,2,1,0,-323,1165],[1,1,-1,0,299,0],[2,0,3,0,294,0],[2,0,-1,-2,0,8752]],tb:[[0,0,0,1,5128122],[0,0,1,1,280602],[0,0,1,-1,277693],[2,0,0,-1,173237],[2,0,-1,1,55413],[2,0,-1,-1,46271],[2,0,0,1,32573],[0,0,2,1,17198],[2,0,1,-1,9266],[0,0,2,-1,8822],[2,-1,0,-1,8216],[2,0,-2,-1,4324],[2,0,1,1,4200],[2,1,0,-1,-3359],[2,-1,-1,1,2463],[2,-1,0,1,2211],[2,-1,-1,-1,2065],[0,1,-1,-1,-1870],[4,0,-1,-1,
1828],[0,1,0,1,-1794],[0,0,0,3,-1749],[0,1,-1,1,-1565],[1,0,0,1,-1491],[0,1,1,1,-1475],[0,1,1,-1,-1410],[0,1,0,-1,-1344],[1,0,0,-1,-1335],[0,0,3,1,1107],[4,0,0,-1,1021],[4,0,-1,1,833],[0,0,1,-3,777],[4,0,-2,1,671],[2,0,0,-3,607],[2,0,2,-1,596],[2,-1,1,-1,491],[2,0,-2,1,-451],[0,0,3,-1,439],[2,0,2,1,422],[2,0,-3,-1,421],[2,1,-1,1,-366],[2,1,0,1,-351],[4,0,0,1,331],[2,-1,1,1,315],[2,-2,0,-1,302],[0,0,1,3,-283],[2,1,1,-1,-229],[1,1,0,-1,223],[1,1,0,1,223],[0,1,-2,-1,-220],[2,1,-1,-1,-220],[1,0,1,1,-185],
[2,-1,-2,-1,181],[0,1,2,1,-177],[4,0,-2,-1,176],[4,-1,-1,-1,166],[1,0,1,-1,-164],[4,0,1,-1,132],[1,0,-1,-1,-119],[4,-1,0,-1,115],[2,-2,0,1,107]]};A.MoonIllum={phaseAngleEq:function(a,b,c,d){return A.MoonIllum._phaseangle(b,d,A.MoonIllum._clngEq(a,c))},phaseAngleEq2:function(a,b){return Math.acos(-A.MoonIllum._clngEq(a,b))},illuminated:function(a){return(1+Math.cos(a))/2},positionAngle:function(a,b){var c=Math.cos(b.dec);return Math.atan2(c*Math.sin(b.ra-a.ra),Math.sin(b.dec)*Math.cos(a.dec)-c*Math.sin(a.dec)*Math.cos(b.ra-a.ra))},_clngEq:function(a,b){return Math.sin(b.dec)*Math.sin(a.dec)+Math.cos(b.dec)*Math.cos(a.dec)*Math.cos(b.ra-a.ra)},
_phaseangle:function(a,b,c){a=Math.atan(b*Math.sin(Math.acos(c))/(a-b*c));0>a&&(a+=Math.PI);return a}};A.Nutation={nutation:function(a){a=a.jdeJ2000Century();for(var b=A.Math.horner(a,[297.85036,445267.11148,-.0019142,1/189474])*Math.PI/180,c=A.Math.horner(a,[357.52772,35999.05034,-1.603E-4,-1/3E5])*Math.PI/180,d=A.Math.horner(a,[134.96298,477198.867398,.0086972,1/5620])*Math.PI/180,e=A.Math.horner(a,[93.27191,483202.017538,-.0036825,1/327270])*Math.PI/180,f=A.Math.horner(a,[125.04452,-1934.136261,.0020708,1/45E4])*Math.PI/180,g=0,k=0,m=A.Nutation.table22A.length-1;0<=m;m--)var h=A.Nutation.table22A[m],
...
36525,A.Sidereal.iau82)+86636.55536784*b[1];a=648E3*A.Nutation.nutationInRA(new A.JulianDay(a[0]))/Math.PI/15;return A.Math.pMod(b+a,86400)}};A.Solar={apparentEquatorial:function(a){var b=a.jdJ2000Century(),c=A.Solar.node(b),b=A.Solar.apparentLongitude(b,c);a=A.Nutation.meanObliquityLaskar(a)+.00256*Math.PI/180*Math.cos(c);c=Math.sin(b);return new A.EqCoord(Math.atan2(Math.cos(a)*c,Math.cos(b)),Math.asin(Math.sin(a)*c))},apparentTopocentric:function(a,b,c){var d=A.Solar.apparentEquatorial(a),e=A.Globe.parallaxConstants(b.lat,b.h);c||(c=A.Sidereal.apparentInRa(a));return A.Parallax.topocentric2(d,A.Parallax.earthsunParallax,e.rhoslat,e.rhoclat,
b.lng,c)},topocentricPosition:function(a,b,c){var d=A.Sidereal.apparentInRa(a);a=A.Solar.apparentTopocentric(a,b,d);b=A.Coord.eqToHz(a,b,d);!0===c&&(b.alt+=A.Refraction.bennett2(b.alt));return{hz:b,eq:a}},approxTimes:function(a,b){a=a.startOfDay();var c=A.Solar.apparentTopocentric(a,b),d=A.Rise.stdh0Solar,e=A.Sidereal.apparent0UT(a);return A.Rise.approxTimes(b,d,e,c)},times:function(a,b){a=a.startOfDay();var c=A.Solar.apparentTopocentric(new A.JulianDay(a.jd-1,a.deltaT),b),d=A.Solar.apparentTopocentric(a,
b),e=A.Solar.apparentTopocentric(new A.JulianDay(a.jd+1,a.deltaT),b),f=A.Rise.stdh0Solar,g=A.Sidereal.apparent0UT(a);return A.Rise.times(b,a.deltaT,f,g,[c,d,e])},meanAnomaly:function(a){return A.Math.horner(a,[357.52911,35999.05029,-1.537E-4])*Math.PI/180},trueLongitude:function(a){var b=A.Math.horner(a,[280.46646,36000.76983,3.032E-4])*Math.PI/180,c=A.Solar.meanAnomaly(a);a=(A.Math.horner(a,[1.914602,-.004817,-1.4E-5])*Math.sin(c)+(.019993-1.01E-4*a)*Math.sin(2*c)+2.89E-4*Math.sin(3*c))*Math.PI/
180;return{s:A.Math.pMod(b+a,2*Math.PI),v:A.Math.pMod(c+a,2*Math.PI)}},apparentLongitude:function(a,b){b||(b=A.Solar.node(a));return A.Solar.trueLongitude(a).s-.00569*Math.PI/180-.00478*Math.PI/180*Math.sin(b)},node:function(a){return(125.04-1934.136*a)*Math.PI/180}};
